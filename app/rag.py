...
# llm = Ollama(model="hf.co/bartowski/phi-4-GGUF:Q5_K_S", temperature=0.3)
llm = Ollama(model="hf.co/bartowski/microsoft_Phi-4-mini-instruct-GGUF:Q8_0", temperature=0.3)
...
retriever = usearch.as_retriever(search_type="similarity", k=2)
